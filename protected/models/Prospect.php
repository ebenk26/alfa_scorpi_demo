...
class Prospect extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('foto_ro,profil_konsumen,nama_surveyor,tipe_approve,keterangan_approve,nama_stnk, no_ro, bid_from_time, foto_1, foto_2, foto_3, note, created_at, updated_at, deleted_at, case_id_reblast, nama_salesman', 'safe'),
