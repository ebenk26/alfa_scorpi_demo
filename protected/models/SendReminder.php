...
/**
 * This is the model class for table "send_reminder".
 *
 * The followings are the available columns in table 'send_reminder':
 * @property integer $id
 ...
 */
class SendReminder extends CActiveRecord
{
	/**
	 ...
	 * @return SendReminder the static model class
	 */
