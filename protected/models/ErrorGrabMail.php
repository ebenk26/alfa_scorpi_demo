...
/**
 * This is the model class for table "error_grab_mail".
 *
 * The followings are the available columns in table 'error_grab_mail':
 * @property integer $id
 ...
 */
class ErrorGrabMail extends CActiveRecord
{
	/**
	 ...
	 * @return ErrorGrabMail the static model class
	 */
