...
<div style="width: 32%;">
	...
	<div class="row">
		<label for="reason_cancel">Alasan Cancel</label>
		<!--<input style="float:right;" type="text" class="reason_cancel" name="reason_cancel" placeholder="">-->
		<?php 
		echo CHtml::textArea('reason_cancel', '', 
					array('id'=>'reason_cancel', 
				   'cols'=>35, 
				   'rows'=>10)); 
		?>
	</div><br>
