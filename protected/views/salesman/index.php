...
$(document).ready(function() {
    ...
    $(".btn-filter").on("click", function (e) 
    {
        ...
        var dealer_val = $('#filter_dealer').val();
        ...
        // if(region_val != '' || status_val!= ''){
            $.ajax({
                ...
                success: function(data) {
                    // $.fn.yiiGridView.update("data-bidding-grid");   
                    $('#data-salesman-grid').yiiGridView('update');
                    // check_role_cond();
                    // location.reload();  
                    // console.log(data);
                    // var chart = $ ( '#yw0' ). highcharts (); 
    ...
    <div class="col-lg-12 col-xs-12">
        <div class="box for-box">
            <div class="box-header with-border">
                <i class="fa fa-flag"></i><h3 class="box-title">SALESMAN TERAKTIF</h3><span class="campaign-list-icon" style="font-size:11px;"></span>
            </div>
            <?php
...
<div class="row header-2">
    <div class="col-md-2"><h4>SALESMAN</h4></div>
</div>
<div class="row">
    <div class="col-md-8">
      <div class="form-group">
        ...
        <input type="text" placeholder="Nama Salesman" id="filter_salesman" name="filter_salesman" class="form-control" style="width: 25%;display:inline-block; opacity:1; border-bottom: none!important;">

        <select id="filter_dealer" name="filter_dealer" class="form-control select2" style="width: 25%;">
